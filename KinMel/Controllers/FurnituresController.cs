...
namespace KinMel.Controllers
{
    ...
    public class FurnituresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SubCategoryId,Title,Description,Condition,Price,PriceNegotiable,Delivery,IsSold,IsActive")] Furnitures furnitures, List<IFormFile> imageFiles)
        {
            if (ModelState.IsValid)
            {
                ...
                if (size > 0)
                {
                    ...
                    furnitures.ImageUrls = await BlobStorageHelper.ListBlobsFolder(slug);
