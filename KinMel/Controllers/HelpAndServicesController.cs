...
namespace KinMel.Controllers
{
    ...
    public class HelpAndServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SubCategoryId,Title,Description,Condition,Price,PriceNegotiable,Delivery,IsSold,IsActive")] HelpAndServices helpAndServices, List<IFormFile> imageFiles)
        {
