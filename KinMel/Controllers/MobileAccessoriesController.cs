...
namespace KinMel.Controllers
{
    ...
    public class MobileAccessoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SubCategoryId,Title,Description,Condition,Price,PriceNegotiable,Delivery,IsSold,IsActive")] MobileAccessories mobileAccessories, List<IFormFile> imageFiles)
        {
