...
namespace KinMel.Controllers
{
    ...
    public class BeautyAndHealthsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SubCategoryId,Title,Description,Condition,Price,PriceNegotiable,Delivery,IsSold,IsActive")] BeautyAndHealth beautyAndHealth, List<IFormFile> imageFiles)
        {
