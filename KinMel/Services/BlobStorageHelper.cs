...
namespace KinMel.Services
{
    public class BlobStorageHelper
    {
        ...
        public static async void UploadBlob()
        {
            // Get a reference to a blob named "myblob".
            CloudBlockBlob blockBlob = container.GetBlockBlobReference("images/abad_skillicon_2.png");

            // Create or overwrite the "myblob" blob with the contents of a local file
            // named "myfile".
            using (var fileStream = System.IO.File.OpenRead(@"D:\EASJ\NotReady\images\abad_skillicon_2.png"))
            {
